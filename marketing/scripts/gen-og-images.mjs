...
const HEADLINE = {
  ...
  "/what-is-ora": ["What is\na .ora file?", "OpenRaster, explained"],
  "/ora-to-png": ["Convert .ora to PNG.\nNothing uploaded.", "OpenRaster converter"],
  "/ora-to-psd": ["Convert .ora to PSD,\nlayers intact.", "OpenRaster converter"],
