    ...
    <section id="features" className="border-t border-zinc-900">
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Feature color="orange"  title="WASM-powered editor"   body="Rust-compiled filters, transforms, and rasterization run at near-native speed on the visitor's CPU — including a pulled-string stroke stabilizer for steady freehand lines and an undo history you can tune up to 1000 steps." tags="Brightness · Contrast · Blur · Crop · Resize · Stabilizer · Undo×1000" />
          ...
          <Feature color="pink"    title="Light, dark, or system" body="A full light theme now sits alongside the original dark one — warm paper or warm earth-tone — with a System option that follows your OS and switches live. Set it in Settings → Appearance; your choice is saved with your account." tags="Light · Dark · System · Saved" />
        </div>
      </div>
    </section>
  );
