    ...
    <section id="features" className="border-t border-zinc-900">
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Feature color="orange"  title="WASM-powered editor"   body="Rust-compiled filters, transforms, and rasterization run at near-native speed on the visitor's CPU — now with integer-math compositing and a live histogram scope computed straight from the image buffer (no per-frame canvas sampling), a pulled-string stroke stabilizer for steady freehand lines, and an undo history you can tune up to 1000 steps." tags="Brightness · Contrast · Blur · Crop · Align · Histogram · Undo×1000" />
          <Feature color="pink"    title="Layered annotations"   body="Rectangles, ellipses, arrows, a Bézier pen for smooth vector paths (with an optional fill, and fully re-editable after you draw it), numbered or lettered callout pins, text, and emoji — plus blur / pixelate / black-box redaction — organized in real-layer stacks with per-layer opacity." tags="Rect · Ellipse · Arrow · Pen · Pins · Text · Redact" />
