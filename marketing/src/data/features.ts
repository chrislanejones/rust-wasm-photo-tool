...
export const FEATURES: FeatureGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Tool Grid", body: "10 tools with gradient icons: Clone Stamp, Resize, Crop, Paint, Text, Arrows (FileText — coming soon), Shapes, Effects (Sparkles), Batch Image Editor (bulk logo stamp + grid mosaic view), AI (Brain)" },
      ...
      { name: "AI Panel", body: "Placeholder cards for: Remove Background (rembg), 4× Upscale (Real-ESRGAN), Object Removal (SD Inpaint), Auto Alt Text (BLIP), Smart Crop, Auto-Enhance — wired to Convex ai_jobs + Replicate when ready" },
