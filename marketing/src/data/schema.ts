...
export const TABLES: Table[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "value", type: "string", comment: "canonical JSON, compared as a string" },
      { name: "rev", type: "number", comment: "server-assigned, strictly increasing" },
      { name: "updatedAt", type: "number" },
      { name: "origin", type: "string", comment: "which device wrote it" },
    ],
    indexes: ["by_userId", "by_userId_key"],
