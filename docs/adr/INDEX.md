...
| [019](019-opt-in-precache-service-worker.md) | The app shell ships behind an opt-in, precache-only service worker | Draft — built + e2e-verified on `feat/service-worker-precache`; ships dark (`VITE_ENABLE_SW` unset), flag flip is Chris's call | 2026-07-19 |
